...
<div class="box-1">
  ...
  <div class="intem-form item-1">
    <label for="">Nome aluno:</label>
     <input class="input-item input-1" type="text" name="nomealuno">
     </div>
     <div class="intem-form">
     <label for="">Idade:</label>
     <input class="input-item input-2"  type="text" name="idade"> 
     </div>
     <div class="intem-form">
     <label for="">Data de Nascimento:</label>
     <input class="input-item input-3"  type="date" name="datanascimento"> 
     </div>
     <div class="intem-form">
     <label for="">endereço:</label>
     <input class="input-item input-4"  type="text" name="endereco"> 
     </div>
   ...
   <!--  <label for="">status</label>
     ...
     <div class="intem-form">
      <label for="">Status:</label>
        <select  class="input-item input-5" id="" name="estatus">
          <option  value=""></option>
            <option class="aprovado" value="ativo">ativo</option>
            <option class="reprovado" value="desativo">desativo</option>
