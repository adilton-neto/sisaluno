...
<div class="box-1">
  ...
  <div class="intem-form item-1">
   ...
   <!--  <label for="">status</label>
     ...
     <div class="intem-form">
      <label for="">Status</label>
        <select  class="input-item" id="" name="estatus">
          <option  value=""></option>
            <option class="aprovado" value="Aprovado">EM atividade</option>
            <option class="reprovado" value="Reprovado">desativo</option>
    ...
    <a href="../sisoaluno-neto-01-08/aluno/index.php"><button class='btn-footer-voltar voltar-1'>voltar</button></a>
