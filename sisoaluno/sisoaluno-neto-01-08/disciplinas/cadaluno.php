...
<div class="box-1">
  ...
  <div class="intem-form item-1">
    <label for="">Nome disciplina</label>
     <input class="input-item" type="text" name="nomedisciplina">
     </div>
     <div class="intem-form">
     <label for="">iD professor</label>
     <input class="input-item"  type="number" name="idprofessor"> 
     </div>
     <div class="intem-form">
     <label for="">Carga horaria</label>
     <input class="input-item"  type="number" name="ch"> 
     </div>
     <div class="intem-form">
     <label for="">Semestre</label>
     <input class="input-item"  type="number" name="semestre"> 
     </div>
